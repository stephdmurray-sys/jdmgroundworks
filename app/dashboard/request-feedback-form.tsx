...
export default function RequestFeedbackForm({ recipientName }: RequestFeedbackFormProps) {
  ...
  const stopRecording = () => {
    setIsRecording(false)
    setFormData({ ...formData, voiceNote: "recorded" })
  }
        ...
        {step < 4 && (
          <>
            ...
            <p className="text-gray-600">
              working with <span className="font-semibold text-gray-900">{recipientName}</span>
            </p>
          </>
        )}
      </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="Candidate">Candidate — I was placed by {recipientName}</option>
              <option value="Hiring Manager">Hiring Manager — {recipientName} sourced candidates for me</option>
              <option value="Colleague">Colleague — We worked together</option>
              <option value="Client">Client — My company hired {recipientName}'s agency</option>
            </select>
          </div>
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              What was it like working with {recipientName}? *
            </label>
            <textarea
              value={formData.feedbackText}
              onChange={(e) => setFormData({ ...formData, feedbackText: e.target.value })}
              placeholder="Be specific about what stood out. For example: 'They were incredibly responsive - they replied within an hour every time. When I had concerns, they were honest and connected me with others...'"
              rows={10}
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 border-2 border-indigo-100">
            ...
            {isRecording && (
              <div className="text-center">
                <div className="text-5xl font-bold text-indigo-600 mb-4 tabular-nums">{formatTime(recordingTime)}</div>
        ...
        <div className="text-center py-8">
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-6 border border-gray-200">
            <p className="text-sm text-gray-600 mb-4">
              Click the link in your email to publish your feedback for {recipientName}.
            </p>
