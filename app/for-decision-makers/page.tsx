  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-semibold text-slate-900 mb-2">{currentContent.sectionLabel}</h2>
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <div className="bg-white border border-slate-200 rounded-2xl p-8 md:p-10 space-y-8">
              {/* Common Themes */}
              <div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-slate-500 mb-6">Instead of</h3>
              <p className="text-slate-700">References you chase</p>
              <p className="text-slate-700">Testimonials written later</p>
              <p className="text-slate-700">Self-reported strengths</p>
            </div>

            {/* You get */}
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-slate-900 mb-6">You get</h3>
              <p className="text-slate-900">Saved feedback in real time</p>
              <p className="text-slate-900">Repeated patterns</p>
              <p className="text-slate-900">One link that shows the truth</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-24 px-6">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-semibold text-slate-900">Review someone in under a minute.</h2>

          <p className="text-lg md:text-xl text-slate-600">See what consistently shows up — before you decide.</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <Link href="/auth/signup" className="text-sm text-slate-600 hover:text-slate-900 transition-colors">
              Create a Nomee link
            </Link>
          </div>
        </div>
